...
def main():
    ...
    _MODELS_MAIN = ['global', 'tabnet_isotonic', 'hard_moe_isotonic',
                    'soft_moe_no_kl_isotonic', 'soft_moe_isotonic']
    _LABELS_MAIN = ['LightGBM', 'TabNet+Iso', 'Hard-MoE+Iso',
                    'Soft-MoE-noKL+Iso', 'Soft-MoE+Iso']
    _COLORS_MAIN = ['#C44E52', '#9467BD', '#937860', '#8C8C8C', '#2E8B57']
    ...
    # ---- Fig J: Calibration comparison bar chart (Table 8) ----
    cal_models = ['global', 'tabnet_isotonic', 'hard_moe_isotonic',
                  'soft_moe', 'soft_moe_isotonic']
    cal_labels = ['LightGBM\n(raw)', 'TabNet\n+Iso', 'Hard-MoE\n+Iso',
                  'Soft-MoE\n(raw)', 'Soft-MoE\n+Iso']
    cal_colors = ['#4C72B0', '#9467BD', '#937860', '#DD8452', '#2E8B57']
    ...
    print("  soft_moe_isotonic_raw.csv          (per-fold: all models incl. tabnet)")
